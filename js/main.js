...
const translations = {
  es: {
    ...
    serv_title: 'Más que una agencia, somos tu <em>infraestructura invisible de viajes</em>',
    serv_desc: 'Operamos detrás de tu marca. Tu cliente, paciente o empleado interactúa contigo. Nosotros ejecutamos la logística completa, negociamos las tarifas y resolvemos cada imprevisto. Tú te llevas el crédito y el retorno económico.',
  ...
  en: {
    ...
    serv_title: 'More than an agency, we are your <em>invisible travel infrastructure</em>',
    serv_desc: 'We operate behind your brand. Your client, patient, or employee interacts with you. We execute the complete logistics, negotiate rates, and solve every unexpected issue. You get the credit and the economic return.',
