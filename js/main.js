...
const translations = {
  es: {
    ...
    serv_desc: 'Operamos detrás de tu marca. Tu cliente, paciente o empleado interactúa "contigo". Cuando en realidad nosotros ejecutamos la logística completa, negociamos las tarifas y resolvemos cada imprevisto. Tú te llevas el crédito y el retorno económico.',
  ...
  en: {
    ...
    serv_desc: 'We operate behind your brand. Your client, patient, or employee interacts with "you". While we actually execute the complete logistics, negotiate rates, and solve every unexpected issue. You get the credit and the economic return.',
