...
const translations = {
  es: {
    ...
    hero_t2: 'Cada viaje de tu empresa es <span class="hero-highlight">dinero</span> que no estás capturando',
  ...
  en: {
    ...
    hero_t2: 'Every trip your company manages today is <span class="hero-highlight">money</span> you are still not capturing',
