...
const translations = {
  es: {
    ...
    hero_t1: 'Convertimos los viajes corporativos en <em>ingresos pasivos</em> para tu empresa',
  ...
  en: {
    ...
    hero_t1: 'We turn corporate travel into <em>passive income</em> for your company',
