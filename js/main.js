...
const translations = {
  es: {
    ...
    hero_t1: 'Lo que hoy te cuesta en viajes puede convertirse en una fuente de <em>ingresos.</em>',
    hero_d1: 'CS Travel Group es la infraestructura logística de viajes que se integra a tu operación sin que tengas que cambiar nada de lo que ya haces. Tus clientes, pacientes o empleados viajan mejor. Tú capturas el valor económico de esa operación. Nosotros nos encargamos de todo lo demás.',
    hero_t2: 'Tu marca al frente. Nosotros detrás. El crédito, <em>tuyo.</em>',
    hero_d2: 'CS Travel Group opera como tu infraestructura invisible de viajes. Tu cliente o paciente interactúa contigo. Nosotros ejecutamos la logística, negociamos las tarifas y resolvemos cada imprevisto. Sin que nadie sepa que existimos.',
    hero_t3: 'Cada viaje que gestionas hoy es dinero que todavía no estás <em>capturando.</em>',
    hero_d3: 'Las empresas que coordinan viajes sin un aliado estratégico están dejando valor en manos de terceros. CS Travel Group te devuelve ese valor con tarifas mayoristas, margen propio y retorno económico desde la primera operación.',
    ...
    prof_title: '¿Con quién trabajas?',
    prof_subtitle: 'Elige el tipo de organización y te llevamos al flujo correcto de cotización, propuesta y seguimiento.',
    prof_c_title: 'Para <br><em>empresas</em>',
    prof_c_desc: 'Gestiona los viajes de tu equipo con tarifas reales y un beneficio que tus empleados no esperaban.',
    ...
    prof_m_title: 'Para médicos <br><em>y clínicas</em>',
    prof_m_desc: 'Ofrécele a tu paciente el servicio completo y genera ingresos sin trabajo adicional.',
    ...
    serv_title: 'Más que una agencia, somos tu infraestructura invisible de viajes',
    serv_desc: 'Operamos detrás de cada viaje para que tú tengas tranquilidad, precisión y resultados.',
    ...
    serv_l1_t: 'Socios de tu marca',
    serv_l1_d: 'Trabajamos como extensión de tu equipo y cuidamos tu reputación.',
    serv_l2_t: 'Expertos en operación',
    serv_l2_d: 'Anticipamos riesgos y resolvemos cualquier imprevisto.',
    serv_l3_t: 'Datos que generan valor',
    serv_l3_d: 'Reportes inteligentes para decisiones estratégicas.',
    serv_l4_t: 'Atención humana siempre disponible',
    serv_l4_d: 'Personas reales que entienden lo que hay detrás de cada viaje.',
    serv_btn: 'Quiero saber más',
    proof_title: 'Lo que dicen quienes ya trabajan con nosotros',
    proof_q1: '"Cita testimonio 1. Aquí va la frase del cliente que menciona el dolor previo, la solución específica y un resultado concreto."',
    proof_q2: '"Cita testimonio 2. Aquí va la frase del cliente que menciona el dolor previo, la solución específica y un resultado concreto."',
    proof_q3: '"Cita testimonio 3. Aquí va la frase del cliente que menciona el dolor previo, la solución específica y un resultado concreto."',
    proof_name: 'Nombre Apellido',
    proof_role: 'Cargo · Empresa',
    diff_title: 'La diferencia entre tener CS Travel y no tenerlo.',
    diff_without: 'Sin CS Travel',
    diff_with: 'Con CS Travel',
    diff_w1: 'Tarifas de mostrador sin negociar',
    diff_w2: 'Horas coordinando por correo',
    diff_w3: 'Nadie responde a las 9pm',
    diff_w4: 'Pacientes que desisten por la logística',
    diff_w5: 'Valor económico en manos de terceros',
    diff_c1: 'Tarifas mayoristas reales',
    diff_c2: 'Un mensaje. Todo resuelto.',
    diff_c3: 'Alguien que responde siempre',
    diff_c4: 'Pacientes que llegan coordinados',
    diff_c5: 'Retorno económico desde el primer viaje',
  ...
  en: {
    ...
    hero_t1: 'What travel costs you today can become a source of <em>revenue.</em>',
    hero_d1: 'CS Travel Group is the travel logistics infrastructure that integrates into your operation without requiring you to change what you already do. Your clients, patients, or employees travel better. You capture the economic value of that operation. We handle everything else.',
    hero_t2: 'Your brand in front. We stay behind. The credit is <em>yours.</em>',
    hero_d2: 'CS Travel Group operates as your invisible travel infrastructure. Your client or patient interacts with you. We execute the logistics, negotiate rates, and solve every unexpected issue without anyone knowing we exist.',
    hero_t3: 'Every trip you manage today is money you are not yet <em>capturing.</em>',
    hero_d3: 'Companies that coordinate travel without a strategic partner leave value in the hands of third parties. CS Travel Group gives that value back to you through wholesale rates, your own margin, and economic return from the first operation.',
    ...
    prof_title: 'Who do you work with?',
    prof_subtitle: 'Choose your organization type and we will guide you to the right quote, proposal, and follow-up flow.',
    prof_c_title: 'For <br><em>companies</em>',
    prof_c_desc: 'Manage your team travel with real rates and a benefit your employees were not expecting.',
    ...
    prof_m_title: 'For doctors <br><em>and clinics</em>',
    prof_m_desc: 'Offer your patient the complete service and generate revenue without additional work.',
    ...
    serv_title: 'More than an agency, we are your invisible travel infrastructure',
    serv_desc: 'We operate behind every trip so you have calm, precision, and results.',
    ...
    serv_l1_t: 'Partners of your brand',
    serv_l1_d: 'We work as an extension of your team and protect your reputation.',
    serv_l2_t: 'Operations experts',
    serv_l2_d: 'We anticipate risks and solve any unexpected issue.',
    serv_l3_t: 'Data that creates value',
    serv_l3_d: 'Intelligent reports for strategic decisions.',
    serv_l4_t: 'Human support always available',
    serv_l4_d: 'Real people who understand what sits behind every trip.',
    serv_btn: 'I want to know more',
    proof_title: 'What people already working with us say',
    proof_q1: '"Testimonial quote 1. Here goes the client phrase mentioning the previous pain, the specific solution, and a concrete result."',
    proof_q2: '"Testimonial quote 2. Here goes the client phrase mentioning the previous pain, the specific solution, and a concrete result."',
    proof_q3: '"Testimonial quote 3. Here goes the client phrase mentioning the previous pain, the specific solution, and a concrete result."',
    proof_name: 'First Last',
    proof_role: 'Role · Company',
    ...
    diff_w1: 'Public counter rates with no negotiation',
    diff_w2: 'Hours coordinating by email',
    diff_w3: 'Nobody answers at 9pm',
    diff_w4: 'Patients who give up because of logistics',
    diff_w5: 'Economic value in third-party hands',
    diff_c1: 'Real wholesale rates',
    diff_c2: 'One message. Everything solved.',
    diff_c3: 'Someone who always responds',
    diff_c4: 'Patients who arrive coordinated',
    diff_c5: 'Economic return from the first trip',
...
const pageTranslations = {
  es: {
    company: {
      ...
      company_ed_title: 'CS Travel es el equipo de viajes que no tienes, pero que siempre deberías haber tenido.',
      ...
      company_ev_title: 'Con CS Travel, tu empresa reduce costos y tu equipo gana beneficios.',
      company_ev_p1: '¿Sabías que los incentivos de viaje son de los más valorados por los equipos, pero de los menos ofrecidos en Colombia?',
      ...
      company_ev_l1_t: '',
      company_ev_l1_d: '✔️ El beneficio se activa automáticamente con tu afiliación',
      company_ev_l2_t: '',
      company_ev_l2_d: '✔️ Tu equipo accede a tarifas que no encuentra por su cuenta',
      company_ev_l3_t: '',
      company_ev_l3_d: '✔️ Un beneficio que valoran y que fideliza a tu equipo',
