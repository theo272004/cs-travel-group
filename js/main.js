...
const pageTranslations = {
  es: {
    company: {
      ...
      company_faq_1_a: 'No. Nuestra retención se basa en resultados, no en contratos forzosos. Trabajamos con empresas que tienen una operación de viajes recurrente y necesitan un aliado profesional.',
