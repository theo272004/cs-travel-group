...
const pageTranslations = {
  es: {
    company: {
      ...
      company_card3_desc: 'Ofrécele a tus clientes, empleados y proveedores un beneficio de viaje que ningún competidor puede igualar. Diseñamos la experiencia, gestionamos la logística y tú te llevas el crédito.',
      company_card3_cta: 'Ver detalle',
      company_card4_tag: 'Logística educativa para tu institución',
      company_card4_desc: 'Colegios, universidades y centros de formación pueden ofrecer a sus estudiantes, docentes y comunidad acceso a tarifas diferenciales de viaje. Tu institución genera un retorno por cada reserva, sin costo ni carga operativa.',
  ...
  en: {
    company: {
      ...
      company_card3_desc: 'Offer your clients, employees, and providers a travel benefit no competitor can match. We design the experience, manage the logistics, and you take the credit.',
      company_card3_cta: 'See details',
      company_card4_tag: 'Educational logistics for your institution',
      company_card4_desc: 'Schools, universities, and training centers can offer students, faculty, and their community access to differential travel rates. Your institution generates a return for every reservation, with no cost or operational burden.',
