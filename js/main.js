...
const pageTranslations = {
  ...
  en: {
    company: {
      ...
      company_fit_title: 'Ten seconds to know if we are right for you.',
      company_fit_desc: '',
      ...
      company_phil_desc: 'We are not a ticket system or a self-service platform. We are real people who understand that behind every trip there is an important meeting, a team that needs to arrive on time, and a company that should not spend more than necessary.',
      company_phil_p2: 'When something goes wrong at 11pm, we respond. When there is a last-minute change, we resolve it before you even need to know. And when the month ends, you have a clear report without having to ask anyone.',
